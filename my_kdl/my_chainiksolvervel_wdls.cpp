...
// ATTENTION: this is a copy of the code from KDL::ChainIkSolverVel_wdls made on the 2016-09-27
// it has to be removed as soon as KDL released version will be >=1.4.0
...
namespace KDL
{
    ...
    my_ChainIkSolverVel_wdls::my_ChainIkSolverVel_wdls(const Chain& _chain,double _eps,int _maxiter):
    chain(_chain),
    jnt2jac(chain),
    ...
    my_ChainIkSolverVel_wdls::~my_ChainIkSolverVel_wdls()
    {
    }
    
    int my_ChainIkSolverVel_wdls::setWeightJS(const MatrixXd& Mq){
    ...
    int my_ChainIkSolverVel_wdls::setWeightTS(const MatrixXd& Mx){
        std::cout << "Resetting weigthTS..." << std::endl;
    ...
    void my_ChainIkSolverVel_wdls::setLambda(const double lambda_in)
    {
        lambda=lambda_in;
    }
    
    void my_ChainIkSolverVel_wdls::setEps(const double eps_in)
    {
        eps=eps_in;
    }
    
    void my_ChainIkSolverVel_wdls::setMaxIter(const int maxiter_in)
    {
        maxiter=maxiter_in;
    }
    
    int my_ChainIkSolverVel_wdls::CartToJnt(const JntArray& q_in, const Twist& v_in, JntArray& qdot_out)
    {
    ...
    */
    ...
    const char* my_ChainIkSolverVel_wdls::strError(const int error) const
    {
