...
#ifndef MY_KDL_CHAIN_IKSOLVERVEL_WDLS_HPP
#define MY_KDL_CHAIN_IKSOLVERVEL_WDLS_HPP

#include "kdl/chainiksolver.hpp"
#include "kdl/chainjnttojacsolver.hpp"
#include <Eigen/Core>

// ATTENTION: this is a copy of the code from KDL::my_ChainIkSolverVel_wdls made on the 2016-09-27
...
namespace KDL
{
     ...
     */
    class my_ChainIkSolverVel_wdls : public ChainIkSolverVel
    {
    public:
        ...
        explicit my_ChainIkSolverVel_wdls(const Chain& chain,double eps=0.00001,int maxiter=150);
        //=ublas::identity_matrix<double>
        ~my_ChainIkSolverVel_wdls();
